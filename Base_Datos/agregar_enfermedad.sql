-- FUNCTION: admece.agregar_enfermedad(character varying, character varying, date, date, boolean, date)

-- DROP FUNCTION IF EXISTS admece.agregar_enfermedad(character varying, character varying, date, date, boolean, date);
